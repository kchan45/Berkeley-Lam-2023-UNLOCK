...
axes[0,0].set_ylabel(r'Surface Temperature ($^\circ C$)')
...
axes[0,1].set_ylabel('Intensity at He 706 nm (arb. units)')

axes[1,0].plot(np.arange(len(I777))*ts, I777, label='Nominal')
axes[1,0].set_xlabel('Time (s)')
axes[1,0].set_ylabel('Intensity at O 777 nm (arb. units)')
